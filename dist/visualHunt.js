(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.VisualHunt = factory());
        ...
        printResults() {
            ...
            if (gameStatsPropsStatus.targets) {
                ...
                if (this.gameStats.config.targets.smallestAverageHitTimingGroup == true) {
                    ...
                    this.groupArray(hitObjects, tgGroupField);
            ...
            this.session.results.filter(function(result){
